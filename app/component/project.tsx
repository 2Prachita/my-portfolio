...
export default function Project({
  ...
  const projectLink = links?.github || links?.demo;
  const isClickable = !!projectLink;

  const Card = (
    <section
      className={`bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] sm:group-even:pl-8 transition dark:bg-white/10 dark:hover:bg-white/20 dark:text-white ${
        isClickable
