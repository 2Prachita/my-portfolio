    ...
    <section ref={ref} id="home" className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]'>
        ...
        >
            ...
            className='group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110
             ...
             href='/PrachitaKotangale.pdf' download>
                Download CV 
            ...
            href='https://www.linkedin.com/in/prachita-kotangale/' target='_blank'>
                <BsLinkedin/>
            </a>
            <a 
            className='bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full text-[1.30rem] focus:scale-[1.15] hover:scale-[1.15]
            hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60'
            href='https://github.com/2Prachita/' target='_blank'>
                <FaGithubSquare/>
            </a>
        </motion.div>
    </section>
